...
if st.session_state['page'] == 'Home':
    ...
    left.image("profile-pic (4).png",width=150)
    with middle:
...
Let’s connect and explore how data can tell better stories and drive smarter decisions—together.
    ...
    icon1.image("python.png",caption="Python")
    icon2.image("sql.png",caption="SQL")

    cat2,icon6,icon7,icon8,icon9,icon10 = st.columns([2,1,1,1,1,1],gap="small",vertical_alignment="top")
    cat2.subheader("Tools")
    icon6.image("power_bi.png",caption="Power BI")
    icon7.image("tableau.png",caption="Tableau")
    icon8.image("excel.png",caption="Excel")
    icon9.image("streamlit.png",caption="Streamlit")

    cat3, icon11,icon12,icon13,icon14,icon15 = st.columns([2,1,1,1,1,1],gap="small",vertical_alignment="top")
    cat3.subheader("Libraries")
    icon11.image("matplotlib.png",caption="Matplotlib")
    icon12.image("pandas.png",caption="Pandas")
    icon13.image("plotly.png",caption="Plotly")
    icon14.image("numpy.png",caption="Numpy")

    cat4, icon16,icon17,icon18,icon19,icon20 = st.columns([2,1,1,1,1,1],gap="small",vertical_alignment="top")
    cat4.subheader("Databases")
    icon16.image("mongodb.png",caption="MongoDB")
    icon17.image("mysql.png",caption="MySql")
    ...
    with side1.container(border=True):
        st.image("dashboard_snapshot.JPG",width=400)
...
if st.session_state['page'] == 'Explanation':
    ...
    with heading:
        ...
        st.image("d2.png",caption="Interns Attendance Dashboard")
